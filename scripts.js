...
//         if(latlon.length === 0){
//             throw new Error("invalid coordinates for the countries");
//            }
...
//     var url=`http://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lang}&appid=551d6e9a2318bc032c165bb852d79099&units=imperial`;
//     var request=new XMLHttpRequest();
